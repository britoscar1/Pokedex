...
def ver_registro_batalla(nombre_entrenador=None):
    ...
    for nombre_archivo in archivos_batalla:
        try:
            with open(nombre_archivo, "r") as archivo:
                contenido = archivo.read()
                if nombre_entrenador and f"Entrenador: {nombre_entrenador}" in contenido:
                    print(contenido)
                    return
    ...
    print(f"\nNo hay registros para el entrenador {nombre_entrenador}.\n")
